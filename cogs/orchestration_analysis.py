            ...
            analysis_prompt = [
                {
                    ...
                    'content': (
                        ...
                        '8. **code_structure_orchestration** should be True when the user asks about visualizing the code base architecture or structure. Return False if only asked to explain.\n'  # New guideline
